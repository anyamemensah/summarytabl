...
For example, the `depressive` dataset contains eight variables that share the same stem (i.e., `dep`), with each one representing a different item (such as a statement, question, or indicator) used to measure depression:
