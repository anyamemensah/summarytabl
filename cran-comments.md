## summarytabl 0.2.1 (2025-10-06).

This patch release (v0.2.1) corrects package dependencies to resolve installation and compatibility issues. This update does not introduce new features or code changes.

## summarytabl 0.2.0 (2025-10-05).
