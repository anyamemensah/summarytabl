...
#'  represents a shared concept before unique identifiers (like timepoints) are added. For
...
#'  waves. By default, missing data are excluded from the calculations in a listwise fashion.
#'
